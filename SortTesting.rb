...
strings = Array.new(10000){ Faker::Alphanumeric.alphanumeric(number: 10) }
...
InsertionStringBucket.time(strings)



strings = Array.new(10000){ Faker::Alphanumeric.alphanumeric(number: 100) }
max = strings.map(&:length).max
